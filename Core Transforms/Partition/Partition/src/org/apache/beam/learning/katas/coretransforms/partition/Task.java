...
public class Task {
  ...
  static PCollectionList<Integer> applyTransform(PCollection<Integer> input) {
    return input.apply(Partition.of(2, new PartitionByThresholdFn(100)));
  }

  static class PartitionByThresholdFn implements PartitionFn<Integer> {

    private final int threshold;

    public PartitionByThresholdFn(int threshold) {
